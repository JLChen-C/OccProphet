# modified from: https://github.com/open-mmlab/mmpretrain/blob/17a886cb5825cd8c26df4e65f7112d404b99fe12/mmpretrain/models/utils/attention.py#
...
class ShiftWindowMSA(nn.Module):
    ...
    Args:
        ...
        drop_prob (dict, optional): The dropout_prob used for DropPath.
            Defaults to 0.
...
class ChannelMultiheadAttention(nn.Module):
    ...
    Args:
        ...
        drop_prob (dict): The dropout prob for DropPath before adding the shoutcut.
            Defaults to 0.
        qkv_bias (bool): If True, add a learnable bias to q, k, v.
            Defaults to False.
    ...
    def __init__(self,
        ...
        self.out_drop = DropPath(drop_prob=drop_prob)
