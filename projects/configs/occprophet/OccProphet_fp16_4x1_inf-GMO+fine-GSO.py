...
# 3 classes: inflated GMO, fine-grained GSO and others
...
task = 'inflated GMO, fine-grained GSO'
num_classes = 3
use_fine_occ = True
...
# Save params ******************************************
save_pred = False
save_path = "./work_dirs/occprophet/OccProphet_fp16_4x1_inf-GMO+fine-GSO/results"
...
work_dir = "./work_dirs/occprophet/OccProphet_fp16_4x1_inf-GMO+fine-GSO"